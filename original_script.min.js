        ...
        vaultChatsBtn.addEventListener('click', (e) => {
            ...
            itemsToSend.forEach((item, index) => {
                setTimeout(() => {
                    ...
                    // Downscale large PC images before broadcasting over Supabase (256kb-1MB limit)
                    const img = new Image();
                    img.onload = () => {
                        let w = img.width;
                        let h = img.height;
                        const MAX_DIM = 600; // Safe threshold for Realtime Broadcast
                        ...
                        // Render locally
                        renderChatMessage(commsUser, "INCOMING IMAGE INTEL", true, originalBase64);
                    };
